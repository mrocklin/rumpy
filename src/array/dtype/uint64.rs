...
impl DTypeOps for Uint64Ops {
    ...
    unsafe fn unary_op(&self, op: UnaryOp, src: *const u8, byte_offset: isize, out: *mut u8, idx: usize) {
        ...
        let result = match op {
            ...
            UnaryOp::Log10 => (v as f64).log10() as u64,
            UnaryOp::Log2 => (v as f64).log2() as u64,
            UnaryOp::Sin => (v as f64).sin() as u64,
            UnaryOp::Cos => (v as f64).cos() as u64,
            UnaryOp::Tan => (v as f64).tan() as u64,
            UnaryOp::Sinh => (v as f64).sinh() as u64,
            UnaryOp::Cosh => (v as f64).cosh() as u64,
            UnaryOp::Tanh => (v as f64).tanh() as u64,
            UnaryOp::Floor => v,
            UnaryOp::Ceil => v,
            UnaryOp::Arcsin => (v as f64).asin() as u64,
            UnaryOp::Arccos => (v as f64).acos() as u64,
            UnaryOp::Arctan => (v as f64).atan() as u64,
