...
impl DTypeOps for Uint8Ops {
    ...
    unsafe fn unary_op(&self, op: UnaryOp, src: *const u8, byte_offset: isize, out: *mut u8, idx: usize) {
        ...
        let result = match op {
            ...
            UnaryOp::Log10 => (v as f64).log10() as u8,
            UnaryOp::Log2 => (v as f64).log2() as u8,
            UnaryOp::Sin => (v as f64).sin() as u8,
            UnaryOp::Cos => (v as f64).cos() as u8,
            UnaryOp::Tan => (v as f64).tan() as u8,
            UnaryOp::Sinh => (v as f64).sinh() as u8,
            UnaryOp::Cosh => (v as f64).cosh() as u8,
            UnaryOp::Tanh => (v as f64).tanh() as u8,
            UnaryOp::Floor => v,
            UnaryOp::Ceil => v,
            UnaryOp::Arcsin => (v as f64).asin() as u8,
            UnaryOp::Arccos => (v as f64).acos() as u8,
            UnaryOp::Arctan => (v as f64).atan() as u8,
