...
class TestBroadcastShapes:
    ...
    def test_same_shape(self):
        r1 = rp.arange(6).reshape(2, 3)
        r2 = rp.arange(6, 12).reshape(2, 3)
    ...
    def test_broadcast_row_column(self):
        # (1, 3) + (2, 1) -> (2, 3)
        r1 = rp.arange(3).reshape(1, 3)
        r2 = rp.arange(2).reshape(2, 1)
    ...
    def test_broadcast_div(self):
        r1 = rp.arange(1, 4, dtype="float64").reshape(1, 3)
        r2 = rp.arange(1, 3, dtype="float64").reshape(2, 1)
...
class TestBroadcastWithViews:
    ...
    def test_broadcast_transposed(self):
        r1 = rp.arange(6).reshape(2, 3)
        r2 = rp.arange(6).reshape(3, 2).T  # (2, 3) via transpose
        n1 = np.arange(6, dtype=np.float64).reshape(2, 3)
...
class TestOuterProduct:
    ...
    def test_outer_mul(self):
        ...
        r1 = rp.arange(3).reshape(3, 1)
        r2 = rp.arange(4).reshape(1, 4)
