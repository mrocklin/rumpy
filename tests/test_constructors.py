...
class TestFull:
    ...
    def test_full_2d(self):
        r = rumpy.full([3, 4], 2.5)
        n = np.full((3, 4), 2.5)
        assert_eq(r, n)

    def test_full_3d(self):
        r = rumpy.full([2, 3, 4], -1.0)
        n = np.full((2, 3, 4), -1.0)
        assert_eq(r, n)
    ...
    def test_full_int_dtype(self):
        r = rumpy.full([3, 3], 7.0, dtype="int64")
